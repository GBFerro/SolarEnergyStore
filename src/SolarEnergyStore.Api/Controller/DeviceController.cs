...
namespace SolarEnergyStore.Api.Controller;
[Route("api/device")]
[ApiController]
public class DeviceController : ControllerBase
{
    ...
    )
    {
        ...
        return response ?
            Ok(new { message = "Temperature record added successfully" })
            : NotFound("No active period found for this device at the specified time.");
    }
    ...
    )
    {
        ...
        return Ok(new { message = "Work period added successfully" });
    }
